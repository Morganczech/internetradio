...
import cz.internetradio.app.data.dao.RadioDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsRadioStations.put("imageUrl", new TableInfo.Column("imageUrl", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsRadioStations.put("description", new TableInfo.Column("description", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoRadioStations.equals(_existingRadioStations)) {
          return new RoomOpenHelper.ValidationResult(false, "radio_stations(cz.internetradio.app.data.entity.RadioEntity).\n"
                  + " Expected:\n" + _infoRadioStations + "\n"
